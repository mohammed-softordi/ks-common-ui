...
function positionEquals(node, top, bottom, left, right) {
  ...
  return rect.top === top && rect.bottom === bottom && rect.left === left &&
      rect.right === right;
}
suite('basic layout', function() {
  ...
  test('layout-horizontal', function() {
    ...
    assert.isTrue(
        positionEquals(container, 0, 50, 0, 300), 'container position ok');
    // |c1| |c2| |c3|
  ...
  test('layout-vertical', function() {
    ...
    assert.isTrue(
        positionEquals(container, 0, 150, 0, 300), 'container position ok');
    // vertically, |c1| |c2| |c3|
    assert.isTrue(positionEquals(c1, 0, 50, 0, 50), 'child 1 position ok');
  ...
  test('layout-wrap', function() {
    ...
    assert.isTrue(
        positionEquals(container, 0, 100, 0, 120), 'container position ok');
    // |c1| |c2|
    // |c3|
    assert.isTrue(positionEquals(c1, 0, 50, 0, 50), 'child 1 position ok');
    assert.isTrue(positionEquals(c2, 0, 50, 50, 100), 'child 2 position ok');
  ...
  test('layout-wrap-reverse', function() {
    ...
    assert.isTrue(
        positionEquals(container, 0, 100, 0, 100), 'container position ok');
    //      |c3|
    // |c2| |c1|
...
suite('flex', function() {
  ...
  test('layout-flex child in a vertical layout', function() {
    ...
    c2.classList.add('flex');
    assert.isTrue(
        positionEquals(container, 0, 300, 0, 300), 'container position ok');
    // vertically, |c1| |    c2    | |c3|
    assert.isTrue(positionEquals(c1, 0, 50, 0, 50), 'child 1 position ok');
  ...
  test(
      'layout-flex, layout-flex-2, layout-flex-3 in a horizontal layout',
      function() {
        container.classList.add('horizontal');
        ...
        assert.isTrue(positionEquals(c1, 0, 50, 0, 50), 'child 1 position ok');
        assert.isTrue(
            positionEquals(c2, 0, 50, 50, 150), 'child 2 position ok');
        assert.isTrue(
            positionEquals(c3, 0, 50, 150, 300), 'child 3 position ok');
      });

  test(
      'layout-flex, layout-flex-2, layout-flex-3 in a vertical layout',
      function() {
        container.classList.add('vertical');
        container.classList.add('tall');
        c1.classList.add('flex');
        ...
        assert.isTrue(positionEquals(c1, 0, 50, 0, 50), 'child 1 position ok');
        assert.isTrue(
            positionEquals(c2, 50, 150, 0, 50), 'child 2 position ok');
        assert.isTrue(
            positionEquals(c3, 150, 300, 0, 50), 'child 3 position ok');
      });
});
...
suite('alignment', function() {
  ...
  test('layout-center', function() {
    ...
    var center = (300 - 50) / 2;
    assert.isTrue(
        positionEquals(c1, center, center + 50, 0, 50), 'child 1 position ok');
  });
  ...
  test('layout-center-justified', function() {
    ...
    var center = (300 - 50) / 2;
    assert.isTrue(
        positionEquals(c1, 0, 50, center, center + 50), 'child 1 position ok');
  });
});
...
suite('justification', function() {
  ...
  test('layout-justified', function() {
    ...
    assert.isTrue(positionEquals(c1, 0, 50, 0, 50), 'child 1 position ok');
    assert.isTrue(
        positionEquals(c2, 0, 50, center, center + 50), 'child 2 position ok');
    assert.isTrue(positionEquals(c3, 0, 50, 250, 300), 'child 3 position ok');
  });
  ...
  test('layout-around-justified', function() {
    ...
    assert.isTrue(
        positionEquals(c1, 0, 50, spacing, spacing + 50),
        'child 1 position ok');
    var end = spacing + 50 + spacing;
    assert.isTrue(
        positionEquals(c2, 0, 50, end + spacing, end + spacing + 50),
        'child 2 position ok');
    end = end + spacing + 50 + spacing;
    assert.isTrue(
        positionEquals(c3, 0, 50, end + spacing, end + spacing + 50),
        'child 3 position ok');
  });
});
...
suite('align-content', function() {
  ...
  test('default is stretch', function() {
    assert.isTrue(
        positionEquals(container, 0, 300, 0, 120), 'container position ok');
  ...
  test('layout-center-aligned', function() {
    ...
    var center = (300 - 50) / 2;
    assert.isTrue(
        positionEquals(c1, center - 50, center, 0, 50), 'child 1 position ok');
    assert.isTrue(
        positionEquals(c2, center - 50, center, 50, 100),
        'child 2 position ok');
    assert.isTrue(
        positionEquals(c3, center, center + 50, 0, 50), 'child 3 position ok');
    assert.isTrue(
        positionEquals(c4, center, center + 50, 50, 100),
        'child 4 position ok');
    assert.isTrue(
        positionEquals(c5, center + 50, center + 100, 0, 50),
        'child 5 position ok');
  });
...
suite('positioning', function() {
  ...
  test('layout-fit', function() {
    ...
    assert.isTrue(
        positionEquals(container, 0, 300, 0, 300), 'container position ok');
    assert.isTrue(
        positionEquals(container, 0, 300, 0, 300), 'child 1 position ok');
  });
});
</script>
  </body>
