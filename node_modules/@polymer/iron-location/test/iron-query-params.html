...
<head>
  ...
  <script type="module" src="../iron-query-params.js"></script>
  <script type="module" src="./replace-state-patch.js"></script>
</head>
...
suite('<iron-query-params>', function() {
  ...
  test('basic functionality with ?key=value params', function() {
    ...
    expect(paramsElem.paramsString).to.be.eq(undefined);
    expect(paramsElem.paramsObject).to.deep.eq(undefined);
