...
gulp.task('generate-externs', gulp.series('clean', async () => {
  let genClosure = require('node_modules/@polymer/gen-closure-declarations').generateDeclarations;
...
gulp.task('generate-typescript', async () => {
  let genTs = require('node_modules/@polymer/gen-typescript-declarations').generateDeclarations;
