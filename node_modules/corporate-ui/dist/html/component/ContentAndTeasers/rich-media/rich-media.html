...
<dom-module id="c-rich-media">
  ...
  <script src="/vendors/components/pure-js/video.js/5.19.2/dist/video.js"></script>
  <script src="/vendors/components/pure-js/videojs-youtube/2.3.2/dist/Youtube.min.js"></script>
  <template>
    <link href="/vendors/components/pure-js/video.js/5.19.2/dist/video-js.css" rel="stylesheet"/>
    <style>/* Rich media */
:host .video-js {
  width: auto;
  height: 100%;
...
:host .sixteen-nine:before {
  display: block;
  content: "";
  width: 100%;
  padding-top: 56.25%;
}
:host .sixteen-nine > .content {
  position: absolute;
  top: 0;
  left: 0;
  right: 0;
...
:host ::content .sixteen-nine .video-js {
  width: auto;
  height: 100%;
}
:host ::content .sixteen-nine .video-js iframe {
  width: 100%;
  height: 100%;
  position: absolute;
  top: 0;
...
:host ::content .sixteen-nine .video-js .vjs-big-play-button {
...
:host ::content .sixteen-nine .video-js .vjs-big-play-button:before {
  position: relative;
  ...
  content: "\e647";
    ...
    </style><div class="sixteen-nine">
            <div class="content">
                <video id="richmedia" class="video-js vjs-default-skin vjs-big-play-centered" controls></video>
            </div>
        </div>

  </template>
  <script>var name = 'c-rich-media'; Polymer({
    is: name,
    properties: {
    ...
    _mediaInit: function (selector) {
        if (this._init == true)
            return;
        this._init = true;
        var videoEl = selector, youtubeUrl = this.url, posterImage = this.coverImg, dataSetup = '{ "fluid": true, "poster": "' + posterImage + '", "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "' + youtubeUrl + '"}]}', á;
        if (youtubeUrl !== '') {
    ...
    lfunction: function (e, i) {
        var t = {}, a = {}, r = false;
        var n = $(e), l = n.attr("id"), o = '<div data-setup="[[data-setup]]" id="[[id]]" class="[[class]]">\r\n    <div style="width:100%;height:100%;position:relative">\r\n        <div id="[[id]]_Youtube_api" 			style="width:100%;height:100%;top:0;left:0;position:absolute"></div>\r\n    </div>\r\n</div>';
        if (l && a[l])
            return a[l];
        var u = i.aspectRatio, s = i.poster, d = JSON.parse(n.attr("data-setup"));
        var c = {};
        c.originalElement = n;
        ...
        c.videoId = v;
        if (!l || "" == l) {
            var y = $('div[id^="youtube_fallback"], video[id^="youtube_fallback"]').length, l = "youtube_fallback_" + y;
        ...
        c.initPlayer = function () {
            var e = this.originalElement.width(), t = e / this.aspectRatio;
