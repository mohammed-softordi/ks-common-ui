...
suite('init', () => {
    ...
    test('runs the given generator when name argument is provided', () => __awaiter(this, void 0, void 0, function* () {
        const runGeneratorStub = sandbox.stub(polymerInit, 'runGenerator').returns(Promise.resolve());
    ...
    test(testName, () => __awaiter(this, void 0, void 0, function* () {
        const promptSelectionStub = sandbox.stub(polymerInit, 'promptGeneratorSelection')
