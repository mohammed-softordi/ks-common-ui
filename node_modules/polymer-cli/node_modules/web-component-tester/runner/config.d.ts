...
export interface NPMPackage {
    /**
     * Name of the node package. e.g. 'node_modules/@polymer/polymer'
     */
    name: string;
    /**
 ...
 * wct-browser-legacy)
 */
export declare function resolveWctNpmEntrypointNames(config: Config, npmPackages: NPMPackage[]): string[];
