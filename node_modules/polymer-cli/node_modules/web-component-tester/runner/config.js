 ...
 * wct-browser-legacy)
 */
function resolveWctNpmEntrypointNames(config, npmPackages) {
    ...
    try {
        ...
        throw new Error(`${wctPackageName} not installed. Please change --wct-package-name` +
    ...
    for (const npmPackage of npmPackages) {
        const absoluteFilepath = resolve.sync(path.join(npmPackage.name, npmPackage.jsEntrypoint), { basedir: wctPackageRoot });
...
exports.resolveWctNpmEntrypointNames = resolveWctNpmEntrypointNames;
