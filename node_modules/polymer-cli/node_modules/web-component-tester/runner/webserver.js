...
const ENVIRONMENT_SCRIPTS = [
    ...
    { name: 'node_modules/@polymer/sinonjs', jsEntrypoint: 'sinon.js' },
    { name: 'sinon-chai', jsEntrypoint: 'lib/sinon-chai.js' },
    {
        name: 'accessibility-developer-tools',
        jsEntrypoint: 'dist/js/axs_testing.js'
    },
    { name: 'node_modules/@polymer/test-fixture', jsEntrypoint: 'test-fixture.js' },
];
/**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (options.npm) {
                ...
                options.clientOptions.environmentScripts =
                    options.clientOptions.environmentScripts || [];
                options.clientOptions.environmentScripts =
                    options.clientOptions.environmentScripts.concat(config_1.resolveWctNpmEntrypointNames(options, ENVIRONMENT_SCRIPTS));
                if (isPackageScoped) {
